...
# uv run scripts/serve_policy.py policy:checkpoint --policy.config=pi0_lego --policy.dir=checkpoints/pi0_lego/first_johannes/13000
...
def create_policy(args: Args) -> _policy.Policy:
    ...
    match args.policy:
        case Checkpoint():
            return _policy_config.create_trained_policy(
                _config.get_config(args.policy.config), args.policy.dir, default_prompt=args.default_prompt           # Possibly change Promt here. Necesasry!!!
            )
        case Default():
